...
const HomePage = () => {
	const { competitors, totalMatches, totalEvaluations, recentMatches } = useRouteLoaderData('root')
			...
			{currentLeader && (
				<section>
					<div className='flex items-center justify-between mb-4'>
						...
						<Link to={`/competitor/${currentLeader.id}`} className='h3 m-0 text-xs hover:text-brand-highlight transition-colors'>
							View_Profile_Data →
						</Link>
					</div>
					<Panel>
