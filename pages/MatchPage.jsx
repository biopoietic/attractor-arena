		...
		<section className='flex-1 flex flex-col'>
			...
			<div>
				<div className='h2 mb-6 flex items-center gap-3'>
					...
					<Link to={`/competitor/${matchData.winnerId}`} className='text-green-500 hover:underline'>
				...
				<div className='mb-8 p-6 bg-brand-surface border border-brand-border'>
					<div className='flex items-center justify-between mb-4'>
						<div className='text-center flex-1'>
							<Link to={`/competitor/${matchData.competitorA.id}`} className='h3 hover:text-brand-text transition-colors'>
						...
						<div className='text-center flex-1'>
							<Link to={`/competitor/${matchData.competitorB.id}`} className='h3 hover:text-brand-text transition-colors'>
