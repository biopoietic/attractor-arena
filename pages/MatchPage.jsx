				...
				<div className='mb-8 p-4 bg-zinc-900/50 border border-zinc-800'>
					<div className='flex items-center justify-between mb-4'>
						<div className='text-center flex-1'>
							...
							<p className={`text-3xl font-bold ${displayMatch.winnerId === displayMatch.competitorA.id ? 'text-rose-500' : 'text-zinc-500'}`}>
								{displayMatch.scoreA}
							</p>
						</div>
						...
						<div className='text-center flex-1'>
							...
							<p className={`text-3xl font-bold ${displayMatch.winnerId === displayMatch.competitorB.id ? 'text-rose-500' : 'text-zinc-500'}`}>
								{displayMatch.scoreB}
							</p>
						</div>
					</div>
